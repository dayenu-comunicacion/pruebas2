...
function removePreviousAmazoniaSlides(){
	...
	if(old_slides.length > 0){
		...
		TweenMax.to(titulo_old, .3, {autoAlpha:0, scale:.7, ease:Power3.easeOut})
...
function animateSlideIntro(){
	...
	*/
	...
	TweenMax.staggerFrom(tituloChars, .7, {opacity:0, scale:0, ease:Power3.easeOut, delay:.7}, 0.15)
	
	
	
	branch = _slidebase.find(".plant_branch");
